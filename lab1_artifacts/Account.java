...
public class Account {
	...
	public String getUsernameOfAccountHolder() {
		return getUsername_of_account_holder();
	}

	public void setUsernameOfAccountHolder(String usernameOfAccountHolder) {
		setUsername_of_account_holder(usernameOfAccountHolder);
	}
	...
	public Date getAccountOpeningDate() {
		return getAccount_opening_date();
	}

	public void setAccountOpeningDate(Date accountOpeningDate) {
		setAccount_opening_date(accountOpeningDate);
	}

	@Override
	public String toString() {
		String formattedDate = new SimpleDateFormat("dd/MM/yyyy").format(account_opening_date);
